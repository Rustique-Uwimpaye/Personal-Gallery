...
class LocationTestCLass(TestCase):
    ...
    def test_update(self):
        ...
        location.update_location('Kasarani')
        location = Location.get_location_id(self.loc.id)
        self.assertTrue(location.name == 'Kasarani')
        
class CategoryTestClass(TestCase):
    
    def setUp(self):
        self.cat = Category(name="fast food")
    ...
    def test_update(self):
        ...
        category.update_category('Visit')
        category = Category.get_category_id(self.cat.id)
        self.assertTrue(category.name == 'Visit')
...
class ImageTestClass(TestCase):
    ...
    def test_search_by_category(self):
        images = Image.search_by_category('fast food')
        self.assertTrue(len(images)>0)
